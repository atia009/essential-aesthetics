...
function loadHeader()
{
 document.querySelector(".header").innerHTML = `
  <nav class="nav">
    <div class="sub-nav">
      <p class="sub-nav__message"><strong class="sub-nav__strong">Schedule an Appointment!</strong> Call during business hours. <a href="#contact" class="sub-nav__link">Contact</a></p>
    </div>
...
function loadFooter()
{
 document.querySelector(".footer").innerHTML = `<div class="foot-content --wrap-horizontal">
      <ul class="foot-pages">
